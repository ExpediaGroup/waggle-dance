...
public class PrimaryMetaStoreTest extends AbstractMetaStoreTest<PrimaryMetaStore> {
  ...
  public void toJson() throws Exception {
    String expected = "{\"accessControlType\":\"READ_ONLY\",\"configurationProperties\":{},\"databasePrefix\":\"\",\"federationType\":\"PRIMARY\",\"metastoreTunnel\":null,\"name\":\"name\",\"remoteMetaStoreUris\":\"uri\",\"status\":\"UNKNOWN\",\"writableDatabaseWhiteList\":[]}";
