...
public class FederatedMetaStoreTest extends AbstractMetaStoreTest<FederatedMetaStore> {
  ...
  public void toJson() throws Exception {
    String expected = "{\"accessControlType\":\"READ_ONLY\",\"configurationProperties\":{},\"databasePrefix\":\"name_\",\"federationType\":\"FEDERATED\",\"mappedDatabases\":[],\"metastoreTunnel\":null,\"name\":\"name\",\"remoteMetaStoreUris\":\"uri\",\"status\":\"UNKNOWN\"}";
