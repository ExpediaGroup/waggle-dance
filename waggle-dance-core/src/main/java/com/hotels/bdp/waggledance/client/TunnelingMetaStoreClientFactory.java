...
public class TunnelingMetaStoreClientFactory implements MetaStoreClientFactory {
  ...
  private static class HiveMetaStoreClientSupplier implements TunnelableSupplier<CloseableIFace> {
    ...
    private HiveMetaStoreClientSupplier(
        MetaStoreClientFactory factory,
        HiveConf hiveConf,
        String name,
  ...
  public TunnelingMetaStoreClientFactory(DefaultMetastoreClientFactory factory) {
    this(new TunnelableFactorySupplier(), factory);
  }

  @VisibleForTesting
  TunnelingMetaStoreClientFactory(TunnelableFactorySupplier tunnelableFactorySupplier, MetaStoreClientFactory factory) {
