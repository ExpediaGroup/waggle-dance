...
| `status-polling-delay`            | No         | Milliseconds. Controls the delay that checks metastore status and updates long running connections of any status change. Default is `300000` (every 5 minutes). 
